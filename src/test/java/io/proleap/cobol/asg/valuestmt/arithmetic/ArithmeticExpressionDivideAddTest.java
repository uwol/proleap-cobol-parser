...
public class ArithmeticExpressionDivideAddTest extends CobolTestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/asg/valuestmt/arithmetic/ArithmeticExpressionDivideAdd.cbl");
...

		{
...

			{
				...
				assertEquals(BigDecimal.valueOf(7), arithmeticExpression.getValue());
			}
		}
	}
}