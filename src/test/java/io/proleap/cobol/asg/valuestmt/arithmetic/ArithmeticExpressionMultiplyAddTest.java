...
public class ArithmeticExpressionMultiplyAddTest extends CobolTestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/asg/valuestmt/arithmetic/ArithmeticExpressionMultiplyAdd.cbl");
...

		{
...

			{
				...
				assertEquals(BigDecimal.valueOf(17), arithmeticExpression.getValue());
			}
		}
	}
}