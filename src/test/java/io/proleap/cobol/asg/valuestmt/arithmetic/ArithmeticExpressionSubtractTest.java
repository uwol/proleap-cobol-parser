...
public class ArithmeticExpressionSubtractTest extends CobolTestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/asg/valuestmt/arithmetic/ArithmeticExpressionSubtract.cbl");
...

		{
...

			{
				...
				assertEquals(BigDecimal.valueOf(3), arithmeticExpression.getValue());
			}
		}
	}
}