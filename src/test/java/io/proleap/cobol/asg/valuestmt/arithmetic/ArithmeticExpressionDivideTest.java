...
public class ArithmeticExpressionDivideTest extends CobolTestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/asg/valuestmt/arithmetic/ArithmeticExpressionDivide.cbl");
...

		{
...

			{
				...
				assertEquals(BigDecimal.valueOf(5), arithmeticExpression.getValue());
			}
		}
	}
}