...
public class WriteStatementTest extends CobolTestSupport {
	...
	public void test() throws Exception {
		...
		final CopyBook copyBook = program.getCopyBook("WriteStatement");
		...
		assertNotNull(writeStatement.getRecordCall());
		assertEquals(Call.CallType.UndefinedCall, writeStatement.getRecordCall().getCallType());
