package io.proleap.cobol.gpl.parser.procedure.unstring;
...
public class UnstringStatementTest extends CobolTestSupport {
	...
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/gpl/parser/procedure/unstring/UnstringStatement.cbl");
...

		{
			...
			{
				final io.proleap.cobol.parser.metamodel.procedure.unstring.Into into = intos.getIntos().get(0);
			...
			{
				final io.proleap.cobol.parser.metamodel.procedure.unstring.Into into = intos.getIntos().get(1);
				final Call intoCall = into.getIntoCall();
				assertEquals(Call.CallType.UndefinedCall, intoCall.getCallType());
