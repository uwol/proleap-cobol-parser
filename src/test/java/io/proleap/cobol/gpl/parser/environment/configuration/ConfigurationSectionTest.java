package io.proleap.cobol.gpl.parser.environment.configuration;
...
public class ConfigurationSectionTest extends CobolTestSupport {
	...
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/gpl/parser/environment/configuration/ConfigurationSection.cbl");
