...
otherKeyword :
	...
	| KANJI | KEPT | KEY
	| LABEL | LAST | LEADING | LEFT | LENGTH | LESS | LIB | LIBRARY | LIMIT | LIMITS | LINAGE | LINE | LINES | LOCAL | LOCK | LOCKFILE | LOWER
